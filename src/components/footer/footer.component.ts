...
@Component({
  ...
  standalone: true,
  template: `
    <footer class="bg-gray-900/70 backdrop-blur-lg border-t border-gray-700/50 py-8 mt-16 z-10">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-500">
        ...
        <p>&copy; {{ currentYear }} DarkShield. All Rights Reserved.</p>
        <p class="mt-1 text-sm font-mono">Forging the future of digital defense.</p>
      </div>
    </footer>
  `,
